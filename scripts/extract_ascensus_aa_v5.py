#!/usr/bin/env python3
"""
Extract Ascensus AA using v5 prompt with provisions + form_elements model
...
def main():
    """Extract Ascensus AA with v5 prompt"""
    sys.stdout.reconfigure(line_buffering=True)

    print("="*80)
    print("V5 AA EXTRACTION - ASCENSUS")
    print("="*80)
    print()
    print("Configuration:")
    ...
    extract_document_parallel(
        ...
        doc_type="AA",
        output_path=Path("test_data/extracted_vision_v5/ascensus_aa_provisions.json"),
        batch_size=1,
        max_workers=16
    )
    ...
    print("="*80)
    print("Check output: test_data/extracted_vision_v5/ascensus_aa_provisions.json")
    print()
