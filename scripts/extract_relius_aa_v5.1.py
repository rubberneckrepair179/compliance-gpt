...
def main():
    ...
    print("="*80)
    print("V5.1 AA EXTRACTION - RELIUS (FULL DOCUMENT)")
    print("="*80)
    print()
    print("Configuration:")
    ...
    extract_document_parallel(
        ...
        doc_type="AA",
        output_path=Path("test_data/extracted_vision_v5.1/relius_aa_provisions.json"),
        batch_size=1,
        max_workers=16
    )
    ...
    print("="*80)
    print("Check output: test_data/extracted_vision_v5.1/relius_aa_provisions.json")
    print()
